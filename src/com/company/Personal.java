...
public class Personal extends LoanP implements Generate{
    public Personal(String clientNumber, String clientName, double loanAmount, int years, String loanType) {
        super(clientNumber, clientName, loanAmount, years, loanType);
    }

    public double computeMonthlyPayment(){
        double monthlyRate = (6 / 100.0) / 12;
